...
func imprimirUso() {
	...
	fmt.Println("  generate, evaluate, run, prepare-phase-two-batch, submit-openai-batch, collect-openai-batch, evaluate-phase-two-batch, prepare-jdk-global-impact, evaluate-jdk-global-impact, measure-jdk-global-impact, help")
}
