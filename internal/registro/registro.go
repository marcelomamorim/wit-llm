...
// Fechar libera o handle do arquivo de log quando configurado via WITUP_LOG_FILE.
// Deve ser chamado uma única vez no encerramento da aplicação (via defer no main).
func Fechar() {
	muSaida.Lock()
